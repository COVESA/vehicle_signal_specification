...
```
3. Follow the instructions in [VSS-tools](https://github.com/COVESA/vss-tools/blob/master/README.md) to prepare an environment suitable for vss-tools (for example a Python virtual environment)
...
**_Note:_** For Windows environment, you need to install GNU make utility, follow instruction under [Make for Windows](https://gnuwin32.sourceforge.net/packages/make.htm)
